...
PowerPlant_Object:
	...
	object_event 34, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_VOLTORB6, VOLTORB, 40
	object_event  4,  9, SPRITE_BIRD,      STAY, UP,   TEXT_POWERPLANT_ZAPDOS, ZAPDOS, 50
	object_event 37, 32, SPRITE_MONSTER,   STAY, DOWN, TEXT_POWERPLANT_MEW, MEW, 40
	...
	object_event 34,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_RARE_CANDY, TM_SUBSTITUTE
	object_event 26, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_TM_THUNDER, TM_THUNDER
	object_event 20, 32, SPRITE_POKE_BALL, STAY, NONE, TEXT_POWERPLANT_TM_REFLECT, TM_DRAGON_RAGE
