...
CeruleanCaveB1F_Object:
	...
	object_event  2, 13, SPRITE_MONSTER, STAY, DOWN, TEXT_CERULEANCAVEB1F_MEW, MEW, 70
	object_event 26,  1, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_ULTRA_BALL1, ULTRA_BALL
	object_event 26, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_ULTRA_BALL2, ULTRA_BALL ; muda depois
	object_event  3, 13, SPRITE_POKE_BALL, STAY, NONE, TEXT_CERULEANCAVEB1F_MAX_REVIVE, MAX_REVIVE ; da pra por um item raro ao lado do mew 
